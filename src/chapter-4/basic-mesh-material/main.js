...
import { initRenderer, initCamera, container, addAxesHelper, addBasicMaterialSettings } from '../../utils';
...
const cameraPostion = new THREE.Vector3(-20, 50, 40);
const lookAtPosition = new THREE.Vector3(10, 0, 0);
camera = initCamera(cameraPostion, lookAtPosition);
